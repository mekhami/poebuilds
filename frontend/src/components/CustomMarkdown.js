...
export default {
  ...
  render(createElement) {
    ...
    const template = this.parseShortcodes(`<div>${outHtml}</div>`, this.itemMap)

    const component = Vue.component('item', {
      template,
      components: {
        'rack-item': RackItem,
        'rack-item-details': RackItemDetails,
        'rack-item-icon': RackItemIcon
      }
    })
